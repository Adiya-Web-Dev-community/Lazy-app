...
const CategoryLoading = () => {
  ...
  return categoryDummyData.map((data) => (
    // Loading element for the category table
    <section className="grid items-center gap-6 py-2 pl-6 pr-4 border-t-2 border-[#1A1A1A] grid-cols-customeCategory group animate-pulse">
