...
export default function MissingCashback({navigation}) {
    ...
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.Second_Container}>
          ...
          <View style={styles.invoiceContainer}>
            <Text style={styles.invoiceTitle}>Upload Current Status of Your Product</Text>
            <TouchableOpacity style={styles.invoiceCard} onPress={pickInvoice}>
              <Text style={styles.invoiceText}>Upload Current Statuis of Your Product</Text>
            </TouchableOpacity>
            {invoice && (
              <View style={styles.pdfContainer}>
                <FontAwesome5 name="file-pdf" size={25} color={COLORS.red} />
