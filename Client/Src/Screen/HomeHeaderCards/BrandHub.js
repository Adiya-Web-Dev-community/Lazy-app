...
const products = [
  { id: 1, title: 'Poco M2', description: 'Best Camera, Processor', image: require('../assets/laptop.jpg') },
  { id: 2, title: 'Realme 3', description: 'Best Camera, Processor', image: require('../assets/laptop.jpg') },
  { id: 3, title: 'Poco M2', description: 'Best Camera, Processor', image: require('../assets/laptop.jpg') },
  { id: 4, title: 'Realme 3', description: 'Best Camera, Processor', image: require('../assets/laptop.jpg') },
];
  ...
  const renderBrandLogoRow = () => (
    ...
    <View style={styles.logoRow}>
      <TouchableOpacity style={styles.logoContainer} onPress={handlecardselection}>
...
<View style={styles.HEADER}>
            ...
            <Text style={{fontSize:moderateScale(19),fontWeight:'500', color:COLORS.Black, marginHorizontal:moderateScale(15)}}>
                Brand Hub
            </Text>
            </View>
<View style={styles.header}>
      ...
      <View style={styles.logoRow}>
              {logos.map((logo) => (
                <TouchableOpacity key={logo.id} style={styles.logoContainer} onPress={handleCardSelection}>
       ...
       <Text style={styles.brandText}>HUAWEI</Text>
         ...
         <Image source={require('../assets/logo.jpg')} style={styles.logo2} />
       ...
       {/* Brand Name/Logo
       <Text style={styles.brandText}>Brand Name/Logo</Text> */}
       ...
       <View style={styles.section}>
        <View style={styles.belowcontainer}>
         ...
         <TouchableOpacity style={styles.rightArrowbtn} onPress={()=>{navigation.navigate('SelectedBrandScreen')}} >
            <Icon
                name="arrowright"
                size={27}
                color={COLORS.Black}
